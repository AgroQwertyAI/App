...
app = FastAPI(
    ...
    version="0.3.0" # Incremented version for change
)
...
def generate_timestamp(days_offset=0, hour=12, minute=0, second=0, base_date=datetime(2024, 7, 15)):
    ...
    # Ensure the format is exactly what fromisoformat expects, including 'Z' for UTC
    # Python's fromisoformat correctly handles 'Z' since 3.7
    return dt.isoformat(timespec='seconds') + "Z"

MOCK_MESSAGES_DB: Dict[str, List[Dict[str, Any]]] = {

    # Chat 1: Field Reports (Focus on Incidents and Observations) - data is a dict
    "field_reports_1": [
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=9, minute=15), # 2024-07-15T09:15:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=9, minute=16)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=14, minute=30), # 2024-07-15T14:30:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=14, minute=31)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=1, hour=8, minute=0), # 2024-07-16T08:00:00Z
            "updated_at": generate_timestamp(days_offset=1, hour=8, minute=1)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=1, hour=11, minute=45), # 2024-07-16T11:45:00Z
            "updated_at": generate_timestamp(days_offset=1, hour=11, minute=46)
        },
         {
            ...
            "timestamp": generate_timestamp(days_offset=2, hour=10, minute=0), # 2024-07-17T10:00:00Z
            "updated_at": generate_timestamp(days_offset=2, hour=10, minute=1)
        },
        { # Older message, potentially outside typical time filter
            ...
            "timestamp": generate_timestamp(days_offset=-7, hour=7, minute=0), # 2024-07-08T07:00:00Z
            "updated_at": generate_timestamp(days_offset=-7, hour=7, minute=1)
        },
    ],

    # Chat 2: Machinery Logs - data is a dict
    "machinery_log_alpha": [
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=7, minute=0), # 2024-07-15T07:00:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=7, minute=1)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=8, minute=35), # 2024-07-15T08:35:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=8, minute=36)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=12, minute=40), # 2024-07-15T12:40:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=12, minute=41)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=1, hour=15, minute=0), # 2024-07-16T15:00:00Z
            "updated_at": generate_timestamp(days_offset=1, hour=15, minute=1)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=1, hour=16, minute=30), # 2024-07-16T16:30:00Z
            "updated_at": generate_timestamp(days_offset=1, hour=16, minute=31)
        },
         {
            ...
            "timestamp": generate_timestamp(days_offset=2, hour=9, minute=0), # 2024-07-17T09:00:00Z
            "updated_at": generate_timestamp(days_offset=2, hour=9, minute=1)
        },
    ],

    # Chat 3: Irrigation Control - data is a dict
    "irrigation_control_west": [
         {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=6, minute=0), # 2024-07-15T06:00:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=6, minute=0)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=6, minute=5), # 2024-07-15T06:05:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=6, minute=5)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=6, minute=15), # 2024-07-15T06:15:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=6, minute=16)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=7, minute=15), # 2024-07-15T07:15:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=7, minute=15)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=8, minute=0), # 2024-07-15T08:00:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=8, minute=0)
        },
    ],

    # Chat 4: Pest Alerts - data is a dict
    "pest_alerts_central": [
        {
            ...
            "timestamp": generate_timestamp(days_offset=1, hour=10, minute=0), # 2024-07-16T10:00:00Z
            "updated_at": generate_timestamp(days_offset=1, hour=10, minute=1)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=1, hour=11, minute=30), # 2024-07-16T11:30:00Z
            "updated_at": generate_timestamp(days_offset=1, hour=11, minute=31)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=1, hour=14, minute=0), # 2024-07-16T14:00:00Z
            "updated_at": generate_timestamp(days_offset=1, hour=14, minute=1)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=2, hour=9, minute=30), # 2024-07-17T09:30:00Z
            "updated_at": generate_timestamp(days_offset=2, hour=9, minute=31)
        },
    ],

    # Chat 5: Agronomist Tasks - data is a dict
    "agronomist_tasks_beta": [
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=9, minute=0), # 2024-07-15T09:00:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=9, minute=1)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=10, minute=30), # 2024-07-15T10:30:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=10, minute=31)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=1, hour=11, minute=0), # 2024-07-16T11:00:00Z
            "updated_at": generate_timestamp(days_offset=1, hour=11, minute=1)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=1, hour=11, minute=15), # 2024-07-16T11:15:00Z
            "updated_at": generate_timestamp(days_offset=1, hour=11, minute=16)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=2, hour=16, minute=0), # 2024-07-17T16:00:00Z
            "updated_at": generate_timestamp(days_offset=2, hour=16, minute=1)
        },
    ],

    # Chat 6: Soil Lab Results - data is a dict
    "soil_lab_results": [
        {
            ...
            "timestamp": generate_timestamp(days_offset=3, hour=10, minute=0), # 2024-07-18T10:00:00Z
            "updated_at": generate_timestamp(days_offset=3, hour=10, minute=0)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=3, hour=10, minute=5), # 2024-07-18T10:05:00Z
            "updated_at": generate_timestamp(days_offset=3, hour=10, minute=5)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=3, hour=10, minute=10), # 2024-07-18T10:10:00Z
            "updated_at": generate_timestamp(days_offset=3, hour=10, minute=10)
        },
    ...
    # Chat 8: Mixed Content - data is a dict
    "mixed_content_chat": [
         {
        ...
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=11, minute=0), # 2024-07-15T11:00:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=11, minute=1)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=0, hour=15, minute=30), # 2024-07-15T15:30:00Z
            "updated_at": generate_timestamp(days_offset=0, hour=15, minute=31)
        },
        {
            ...
            "timestamp": generate_timestamp(days_offset=1, hour=10, minute=0), # 2024-07-16T10:00:00Z
            "updated_at": generate_timestamp(days_offset=1, hour=10, minute=0)
        },
         { # Message with cost data for SUM aggregation testing
            ...
            "timestamp": generate_timestamp(days_offset=1, hour=12, minute=0), # 2024-07-16T12:00:00Z
            "updated_at": generate_timestamp(days_offset=1, hour=12, minute=1)
        },
         { # Another purchase for the same field
            ...
            "timestamp": generate_timestamp(days_offset=2, hour=13, minute=0), # 2024-07-17T13:00:00Z
            "updated_at": generate_timestamp(days_offset=2, hour=13, minute=1)
        },
    ],

    # **** NEW CHAT FOR TESTING LIST-BASED DATA ****
    "daily_reports_aggregated": [
        {
            "_id": "dra_001", "message_id": "901", "source_name": "report_system", "chat_id": "daily_reports_aggregated",
            "text": "Сводный отчет по операциям за день.",
            "sender_id": "sys_reporter", "sender_name": "System Reporter", "image": None,
            # Data field contains a LIST of dictionaries
            "data": [
                {'Дата': '', 'Подразделение': 'АОР Центр', 'Операция': 'Пахота', 'Культура': 'Соя товарная', 'За день, га': '141', 'С начала операции, га': '1402', 'Вал за день, ц': '', 'Вал с начала, ц': ''},
                {'Дата': '', 'Подразделение': 'АОР Юг', 'Операция': 'Выравнивание зяби', 'Культура': 'Кукуруза кормовая', 'За день, га': '16', 'С начала операции, га': '16', 'Вал за день, ц': '', 'Вал с начала, ц': ''},
                {'Дата': '', 'Подразделение': 'АОР Юг', 'Операция': 'Выравнивание зяби', 'Культура': 'Свекла сахарная', 'За день, га': '376', 'С начала операции, га': '912', 'Вал за день, ц': '', 'Вал с начала, ц': ''},
                {'Дата': '', 'Подразделение': 'АОР Центр', 'Операция': 'Дискование 2-е', 'Культура': 'Свекла сахарная', 'За день, га': '349', 'С начала операции, га': '1041', 'Вал за день, ц': '', 'Вал с начала, ц': ''}
            ],
            "timestamp": generate_timestamp(days_offset=4, hour=8, minute=0), # 2024-07-19T08:00:00Z
            "updated_at": generate_timestamp(days_offset=4, hour=8, minute=1)
        },
        # You could add more messages here, some with dict data, some with list data,
        # if you wanted to test normalization on mixed content within the same chat.
    ]
    # **** END OF NEW CHAT ****
}
...
async def get_chat_messages(chat_id: str):
    ...
    if messages:
        # Check if the message contains data that needs normalization for logging purposes
        contains_list_data = any(isinstance(msg.get('data'), list) for msg in messages)
        if contains_list_data:
             logger.info(f"Found data for chat_id '{chat_id}' containing list-based 'data' fields. Returning {len(messages)} original message(s).")
        else:
